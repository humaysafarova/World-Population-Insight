...
Checked for missing values using isna()
Checked for duplicate records using duplicated()
Renamed columns for easier usage

Exploratory Data Analysis

Distribution of country populations in 2023
Average population by continent
Top populated countries
Relationship between population and density
Land area comparison between continents
Population density distribution across continents
